...
\begin{figure}[!h]
\centering
\subfigure[ShuffleNetv2] {\includegraphics[width=0.49\textwidth]{images/exp1-shufflenet.png}}
...
\subfigure[Inceptionv3] {\includegraphics[width=0.49\textwidth]{images/exp1-inception.png}}
\caption{\centering Training performance on CIFAR-100 using regular SGD training and P-SGD training in 40-dimensional subspaces.}
\label{fig:exp1-app}
\end{figure}
