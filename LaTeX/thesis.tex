...
The convergence of stochastic gradient descent will be extensively investigated in section \ref{sec:Experiments}. \\
...
\hline \hline \multicolumn{10}{c}{} \\ [-2.5ex]
& \multicolumn{10}{c}{\#samples} \\
...
\begin{tabu} to \textwidth { c | r | X[c] X[c] X[c] | X[c] X[c] }
\hline \hline \multicolumn{7}{c}{} \\ [-2.5ex]
\multirow{3}{*}{model} & \multirow{3}{*}{\#params} & \multicolumn{3}{c|}{Training time (s/epoch)} & \multicolumn{2}{c}{DLDR time (s)} \\
& & \multicolumn{3}{c|}{optimizer} & \multicolumn{2}{c}{\#samples} \\
